...
public class ItemListener {
    ...
    public void listener(Long spuId, Channel channel, Message message){
       ...
       SpuEntity spuEntity = spuEntityResponseVo.getData();
        ...
        ResponseVo<List<SkuEntity>> skuResponseVo = this.pmsClient.querySkuBySpu(spuId);
        ...
        if(!CollectionUtils.isEmpty(skuEntities)){
            ...
            List<Goods> goodsList = skuEntities.stream().map(skuEntity -> {
                ...
                // 查询基本类型的检索参数
                ResponseVo<List<SpuAttrValueEntity>> spuAttrValueResponseVo = this.pmsClient.querySearchSpuAttrValueByCidAndSpuId(skuEntity.getCatagoryId(), spuId);
